...
public class AccountDetailsConstants {
    ...
    public static final String BANK_VI_NAME = "Bank of Bharat";
    public static final String BANK_VI_BRANCH = "Bank of Bharat - Bhopal Indian Central Branch";
    public static final String BANK_VI_ROUTING = "Bank of Bharat - Bhopal City Branch 456 Park Road MP Nagar Bhopal, 462011 India";
    public static final String BANK_VI_STATUS = "002";
    public static final String BANK_VI_ACCOUNT_CREATED = "YOUR ACCOUNT HAS BEEN CREATED SUCCESSFULLY !! ";
